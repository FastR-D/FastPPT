...
| 2026-09 | **Local Project Studio** — a pnpm-managed TypeScript/Fastify and React control plane for page/deck conversations, Claude/Codex Agent jobs, revision conflicts, transactional multi-page staging, continuous SSE, shared confirmation gates, route-aware checking/export, recovery, and user-approved project memory; project files remain authoritative and Studio remains a Skill surface rather than SaaS |
