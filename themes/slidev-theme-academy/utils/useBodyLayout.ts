...
export interface BodyLayoutProps {
  density?: 'normal' | 'compact' | 'dense' | undefined
  margin?: 'normal' | 'tight' | 'tighter' | 'none' | undefined
  footnote?: 'overlay' | 'flow' | undefined
  sectionBar?: boolean | undefined
  lineHeight?: number | undefined
  flowGap?: string | number | undefined
...
export function useBodyLayout(props: BodyLayoutProps) {
  ...
  const pageStyle = computed(() => {
    ...
    Object.assign(s, resolveBodyMargin(props.margin))
