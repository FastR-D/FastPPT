...
| Editing files under `node_modules/.../slidev-theme-academy/`           | **Never** — outside project scope; wiped on reinstall. Use a wrapper `<div style="…">` for one-offs; file an upstream feature request / PR for reusable changes |
