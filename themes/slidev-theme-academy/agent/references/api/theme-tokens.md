...
| Variable                  | Default              | Role                                                                                                          |
| ------------------------- | -------------------- | ------------------------------------------------------------------------------------------------------------- |
| `--ustc-box-border-color` | `var(--ustc-blue)`   | border color when `border` is `true` — defaults to full Academy blue (`#1e4c90`) for a clean, clearly-visible edge |
...
| `--ustc-box-bg-gray`      | `#f5f5f5`            | soft-gray surface resolved by `<Box bg="gray-soft">`; theme's neutral surface color, not tied to Academy blue    |
