...
def extract_pptx_import_manifest(
    ...
    *,
    ...
    return {"source_artifact_id": source_artifact_id, "source_sha256": source_hash, "page_size": page_size, "pages": pages, "aggregate_sha256": aggregate, "schema_version": "1.1.0"}
